...
{
    public class MaintainAccuracyMissionObjectiveChecker : MissionObjectiveChecker, CustomTracker
    {
        ...
        {
            return ChallengeRequirement.GetObjectiveName("maintainAccuracy");
        }
    }
}
